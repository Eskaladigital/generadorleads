          ...
          templates: [
            {
              ...
              content: `
                <div class="cta-box">
                  ...
                  <p><a href="/es/contacto" style="display:inline-block;background:#3b82f6;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;">Solicitar ayuda gratis →</a></p>
                </div>
              `
            },
            {
