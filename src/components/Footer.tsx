      ...
      <footer className="stats-minimal">
        <div className="container-base">
          ...
          <div className="grid md:grid-cols-5 gap-12 md:gap-16 pb-16 border-b border-gray-800">
            <div className="md:col-span-2">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3 text-gray-300">
                  ...
                  <a href="mailto:info@health4spain.com" className="hover:text-white transition-colors">
              ...
              {/* Social Media */}
              <div>
                <h4 className="text-sm font-bold mb-4 uppercase tracking-widest text-gray-400">Síguenos</h4>
                <div className="flex gap-4">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="text-accent hover:text-white transition-colors hover:scale-110 transform"
              ...
              <ul className="space-y-3">
                {servicios.map((servicio) => (
                  <li key={servicio.slug}>
                    <Link href={`/es/servicios/${servicio.slug}`} className="text-base text-gray-300 hover:text-white hover:pl-2 transition-all">
            ...
            {/* Destinos */}
            <div>
              <h4 className="text-sm font-bold mb-6 uppercase tracking-widest text-gray-400">Destinos Principales</h4>
              <ul className="space-y-3">
                {footerLinks.destinos.map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} className="text-base text-gray-300 hover:text-white hover:pl-2 transition-all">
                      {link.label}
                    </Link>
                  </li>
                ))}
                <li>
                  <Link href="/es/destinos" className="text-base text-accent hover:text-accent-400 font-semibold">
          ...
          <div className="py-8 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="stat-label text-center md:text-left">
              © {new Date().getFullYear()} Health4Spain. Todos los derechos reservados.
            </p>
