...
const footerLinks = {
  ...
  destinos: [
    ...
    { href: '/es/destinos/madrid', label: 'Madrid' },
    { href: '/es/destinos/barcelona', label: 'Barcelona' },
    { href: '/es/destinos/islas', label: 'Islas' },
  ],
  empresa: [
    { href: '/es/sobre-nosotros', label: 'Sobre nosotros' },
    { href: '/es/blog', label: 'Blog' },
    { href: '/es/contacto', label: 'Contacto' },
    { href: '/es/partners', label: 'Colaboradores' },
  ],
  legal: [
    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="container-base py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          {/* Destinos */}
          <div>
            <h4 className="font-heading font-semibold text-white mb-3">Destinos</h4>
            <ul className="space-y-2">
          ...
          {/* Empresa */}
          <div>
            <h4 className="font-heading font-semibold text-white mb-3">Empresa</h4>
            <ul className="space-y-2">
      ...
      <div className="border-t border-gray-800">
        <div className="container-base py-4 flex flex-col md:flex-row justify-between items-center gap-4">
