...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates(locale, '/reiseziele'),
};
  ...
  return (
    <>
      <section className="hero-with-image hero-compact">
        <div className="absolute inset-0 z-0"><Image src={HERO_IMAGES.destinos} alt="Reiseziele in Spanien für Ausländer" fill priority fetchPriority="high" sizes="100vw" className="object-cover object-center" /></div>
        <div className="hero-content-box">
          ...
          <Link href="/de/anfrage" className="btn-minimal-lg">{t.home.requestInfo}</Link>
        </div>
      </section>

      <section className="section-alt">
        <div className="container-narrow space-y-12">
          <Breadcrumbs items={[{ label: t.common.breadcrumbHome, href: '/de' }, { label: t.destinations.title }]} />
            ...
            <div key={zona}>
              ...
              <div className="mt-6 space-y-0">
                {ciudadesZona.map((ciudad) => (
                  <Link key={ciudad.slug} href={`/de/anfrage?ciudad=${ciudad.slug}`} className="group flex justify-between items-center py-4 border-b border-gray-300 hover:bg-white hover:pl-3 transition-all">
                    <div>
      ...
      <section className="section text-center">
        <div className="container-narrow">
          ...
          <Link href="/de/anfrage" className="btn-minimal-lg">{t.home.requestInfoNow}</Link>
        </div>
      </section>
    </>
  );
