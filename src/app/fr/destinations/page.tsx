  ...
  return (
    <>
      <section className="hero-with-image hero-compact">
        <div className="absolute inset-0 z-0"><Image src={HERO_IMAGES.destinos} alt="Destinations en Espagne pour étrangers" fill priority fetchPriority="high" sizes="100vw" className="object-cover object-center" /></div>
      ...
      <section className="section-alt">
        <div className="container-narrow space-y-12">
          <Breadcrumbs items={[{ label: t.common.breadcrumbHome, href: '/fr' }, { label: t.destinations.title }]} />
            ...
            <div key={zona}>
              ...
              <div className="mt-6 space-y-0">
                {ciudadesZona.map((ciudad) => (
                  <Link key={ciudad.slug} href={`/fr/demande?ciudad=${ciudad.slug}`} className="group flex justify-between items-center py-4 border-b border-gray-300 hover:bg-white hover:pl-3 transition-all">
                    <div>
