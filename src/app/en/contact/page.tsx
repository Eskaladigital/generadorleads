    ...
    <>
      ...
      <section className="section-alt">
        <div className="container-narrow">
          <Breadcrumbs items={[{ label: t.common.breadcrumbHome, href: '/en' }, { label: t.contact.title }]} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Link href="/en/request" className="profile-card group hover:border-accent transition-all">
      ...
      <section className="section-blue-dark pb-0">
        <div className="container-narrow pb-8 md:pb-12 text-center">
          ...
          <Link href="/en/request" className="btn-minimal-white">{t.contact.fillForm}</Link>
        </div>
      </section>
